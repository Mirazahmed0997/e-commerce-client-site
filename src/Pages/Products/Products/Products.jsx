...
export default function Products() {
    ...
    }, [param.levelThree,param.levelOne, colorValue, sizeValue,discount, priceValue, sortValue, stock,pageNumber])
                    ...
                    <div className="fixed inset-0 z-40 flex">
                        ...
                        >
                            ...
                            <form className="mt-4 border-t border-gray-200 mt-36">
                                ...
                                {filters.map((section) => (
                                    <Disclosure key={section.id} as="div" className="border-t border-gray-200 px-4 py-6 mt-6">
